...
?>
			<div class="row">
				...
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
					...
					<div class="form-group">
					<label>TAX ID</label>
						<input type="text" class="form-control" name="gst" id="gst" placeholder="TAX ID" autocomplete="off" required value="<?php echo $_POST['gst']; ?>">
					</div>
					<div class="form-group">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<table class="table table-bordered table-hover" id="invoiceItem">
						<tr>
							...
							<th width="10%" class="igst_text" style="display:none">TAX</th>
						...
						<tr>
							...
							<td style="display:none"><input type="text" name="productCode[]" id="productCode_1" class="form-control" autocomplete="off"></td>
			...
			<div class="row">
				...
				<div class="form-group">
					...
					<?php $declaration = '';?>
					<textarea class="form-control declarationtext" rows="3" class="col-md-12"  name="declaration" id="declaration" placeholder="Declaration" required maxlength="160" ><?php echo !empty($_POST['declaration']) ? $_POST['declaration'] : $declaration; ?></textarea>
					<small iclass="form-text text-muted">Not more than 160 characters.</small><small id="showtotal"></small>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="form-group">
					...
					<textarea class="form-control" rows="3" class="col-md-12"  name="terms" id="terms" placeholder="Terms and conditions" maxlength="160" <?php echo ($_POST['termstrue'] != 1) ? 'style="display:none"' : ''; ?> ><?php echo $_POST['terms']; ?></textarea>
