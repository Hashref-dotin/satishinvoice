...
if (!empty($_POST['companyName']) && $_POST['companyName'] && !empty($_POST['invoiceId']) && $_POST['invoiceId']) {
    ...
    if (isset($_POST['invoice_btn'])) {
        header("Location:prowin_list.php");
    }
		      	...
		      	<div class="row">
		      		<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
						...
						<div class="form-group">
							...
							<a href="print_prowin.php?invoice_id=<?php echo $invoiceValues['order_id']; ?>" target="_blank"><button type="button" class="btn btn-primary btn-sm">Print PDF</button></a>
			      		</div>
