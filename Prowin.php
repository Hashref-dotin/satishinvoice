...
class Invoice
{
    ...
    public $invoiceOrderTable = 'prowin_invoice_order';
    private $invoiceOrderItemTable = 'prowin_order_item';
...
define('WEBPAGE_TITLE', 'Prowin Invoicing');
$prowincompanyabactive = 'active highlighttab';
