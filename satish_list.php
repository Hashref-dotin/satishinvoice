...
<?php include 'container.php';?>
    ...
    <form action="satish_list.php" method="POST">
...
foreach ($invoiceList as $invoiceDetails) {
    ...
    echo '
              <tr>
                ...
                <td><a href="print_satish.php?invoice_id=' . $invoiceDetails["order_id"] . '" target="_blank" title="Print Invoice"><span class="glyphicon glyphicon-print"></span></a></td>
                <td><a href="print_satish.php?invoice_id=' . $invoiceDetails["order_id"] . '&download=1" target="_blank" title="Print Invoice"><span class="glyphicon glyphicon-download"></span></a></td>
                <td><a href="edit_satish.php?update_id=' . $invoiceDetails["order_id"] . '" target="_blank" title="Edit Invoice"><span class="glyphicon glyphicon-edit"></span></a></td>
                <td><a href="#" id="' . $invoiceDetails["order_id"] . '" class="deleteSatish"  title="Delete Invoice"><span class="glyphicon glyphicon-remove"></span></a></td>
              </tr>
            ';
    $sl++;
}
