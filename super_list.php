...
foreach ($invoiceList as $invoiceDetails) {
    ...
    echo '
              <tr>
                ...
                <td><a href="print_super.php?invoice_id=' . $invoiceDetails["order_id"] . '" target="_blank" title="Print Invoice"><span class="glyphicon glyphicon-print"></span></a></td>
                <td><a href="print_super.php?invoice_id=' . $invoiceDetails["order_id"] . '&download=1" target="_blank" title="Print Invoice"><span class="glyphicon glyphicon-download"></span></a></td>
                <td><a href="edit_super.php?update_id=' . $invoiceDetails["order_id"] . '" target="_blank" title="Edit Invoice"><span class="glyphicon glyphicon-edit"></span></a></td>
                <td><a href="#" id="' . $invoiceDetails["order_id"] . '" class="deleteSuper"  title="Delete Invoice"><span class="glyphicon glyphicon-remove"></span></a></td>
              </tr>
            ';
    $sl++;
}
