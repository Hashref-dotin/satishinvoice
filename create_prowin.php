...
if (!empty($_POST['companyName']) && !empty($_POST['mobile']) && !empty($_POST['email'])) {
	if (empty($_POST['order_date']) && !checkDateForm($_POST['order_date'])) {
        ...
        if (!is_numeric($id)) {
            ...
            header("Location:edit_prowin.php?update_id=" . $id);
        }
    }
...
Prowin corporation (seller) does not give any guarantee or takes any responsibility on used machines, it will be bought as where it is condition.';?>
			...
			<div class="row">
				...
				<div class="form-group">
					...
					2) Price are exworks Prowin corporation Company
			...
			<div class="row">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					...
					<div class="form-group">
						...
						<input type="hidden" value="Satish" class="form-control" id="whoisuser" name="whoisuser">
