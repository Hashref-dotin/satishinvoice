 $(document).ready(function() {
     ...
     $(document).on('click', '.deleteSatish', function() {
         var id = $(this).attr("id");
         if (confirm("Are you sure you want to remove this?")) {
             $.ajax({
                 url: "action_super.php",
     ...
     function responseParse(data) {
         /*[{"id":"37","label":"BHAGAVATHI INDUSTRIES","value":"BHAGAVATHI INDUSTRIES","order_receiver_address":"No 1, Sanjay Gandhi Nagar, \r\n(Sathya Nagar Extention) Padi, \r\nChennai - 600 050\r\n","gst":"33AAAFB0466D1Z6","email":"bhagavathi_ind@rediffmail.com","mobile":"04426246217"}]e*/

     }
     $("#companyName").autocomplete({
         source: "search.php?whoisuser=" + $("#whoisuser").val(),
         minLength: 2,
         select: function(event, ui) {
             console.log("Selected: " + ui.item.value + " aka " + ui.item.id);
             $("#address").val(ui.item.order_receiver_address);
             $("#gst").val(ui.item.gst);
